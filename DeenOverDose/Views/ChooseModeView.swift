                ...
                VStack {
                    ...
                    ZStack {
                        Image("modeButton")
                            .resizable()
                            .aspectRatio(contentMode: .fit)
                            .frame(width: sizeClass == .compact ? geo.size.width / 1.2 : geo.size.width / 1.4)
                        Image("storyTitle")
                            .resizable()
                            .aspectRatio(contentMode: .fit)
                            .frame(height: sizeClass == .compact ? geo.size.height / 18.5 : geo.size.height / 20.0)
                            .offset(x: -25)
                        Image("storyRibbon")
                            .resizable()
                            .aspectRatio(contentMode: .fit)
                            .frame(width: sizeClass == .compact ? geo.size.width / 5.5 : geo.size.width / 6.5)
                            .offset(x: sizeClass == .compact ? geo.size.width / 3.5 : geo.size.width / 5.0, y: sizeClass == .compact ? geo.size.width / -18.5 : geo.size.width / -25.0)
                    }
                    .padding(.bottom, 15)
                    .offset(x: sizeClass == .compact ? -geo.size.width / 25.5 : -geo.size.width / 9.5)
                    ZStack {
                        Image("modeButton")
                            .resizable()
                            .aspectRatio(contentMode: .fit)
